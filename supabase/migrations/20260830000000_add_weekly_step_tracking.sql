create table public.weekly_step_goals (
...
create table public.weekly_step_logs (
  id uuid primary key default gen_random_uuid(),
...
create index weekly_step_goals_pact_user_idx on public.weekly_step_goals(pact_id, user_id);
create index weekly_step_logs_pact_user_idx on public.weekly_step_logs(pact_id, user_id, logged_at asc);
